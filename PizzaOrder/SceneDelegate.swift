...
//
//  Created by Shamkhal Guliyev on 08.03.23.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if UserDefaults.standard.bool(forKey: "loggedIn") {
            setSecondRootController(windowScene: windowScene)
        } else {
    ...
    func setSecondRootController(windowScene: UIWindowScene) {
        ...
        window?.rootViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "tbvc") as! UITabBarController
